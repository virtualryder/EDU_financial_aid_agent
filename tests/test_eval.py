...
Golden cases pin the Pell/SAP DETERMINATION so a rules change (Pell max/min, SAP thresholds, proration)
that alters an outcome fails CI. Rules basis: authoritative 2026-27 Pell max 7395 / min 740; SAP GPA >= 2.0
and pace >= 67%.
"""
import pytest
...
GOLDEN = [
    ...
    ("half_time_proration",
     {"student_aid_index": 0, "cost_of_attendance": 25000, "enrollment_status": "half",
      "sap_gpa": 3.0, "sap_pace": 80, "deidentified": True},
    ...
    ("sap_not_met_needs_review",
     {"student_aid_index": 1000, "cost_of_attendance": 25000, "enrollment_status": "full",
      "sap_gpa": 1.0, "sap_pace": 40, "deidentified": True},
    ...
    ("verification_hold",
     {"student_aid_index": 2000, "cost_of_attendance": 25000, "enrollment_status": "full",
      "sap_gpa": 3.0, "sap_pace": 80, "selected_for_verification": True, "deidentified": True},
