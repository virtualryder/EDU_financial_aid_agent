...
@pytest.mark.parametrize("tool,extra,flag", [
    ("assess_aid", {"student_aid_index": 2500, "cost_of_attendance": 22000,
                    "enrollment_status": "full"}, "assessed"),
    ("professional_judgment", {"circumstance": "job loss",
                               "rationale": "Documented 2026 layoff reduced income 40 percent"}, "prepared"),
])
...
def test_forged_ref_is_refused():
    ...
    r = call("assess_aid",
             {"student_aid_index": 2500, "cost_of_attendance": 22000,
