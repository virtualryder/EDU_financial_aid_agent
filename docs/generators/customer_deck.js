...
(() => {
  ...
  const stats = [["32/32", "governance checks pass, live", MINT], ["Pell+SAP", "computed deterministically", TEAL], ["100%", "of awards gated by an aid officer", AMBER]];
