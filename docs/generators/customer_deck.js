...
(() => {
  ...
  const stats = [["318/318", "automated tests green in CI", MINT], ["End-to-end", "proven live - inside a locked-down private network", TEAL], ["100%", "of determinations gated by an aid officer", AMBER]];
