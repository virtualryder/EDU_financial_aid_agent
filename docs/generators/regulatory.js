...
const body = [
  ...
  table(["Safeguards / Pub 1075 area", "How the accelerator addresses it", "Status / institution responsibility"], [
    ...
    ["Written security program & assessment", "Reproducible, manifest-driven infrastructure-as-code and a 299-test automated suite gating every change in CI plus a captured clean-account live validation run (evidence/EP1-VALIDATION.md).", [{ text: "Institution: ", bold: true }, "the WISP, risk assessment, and qualified individual per the Safeguards Rule."]],
  ], [2500, 4240, 3700]),
