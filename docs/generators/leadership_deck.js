...
(() => {
  ...
  const stats = [["337/337", "automated tests green", MINT], ["10/10", "concurrent runs live-proven", TEAL], ["0", "PII hits in any telemetry (strict canary)", AMBER], ["0", "residual on teardown", NAVY]];
...
p.writeFile({ fileName: require("path").join(__dirname, "..", "Financial-Aid-AgentCore-Leadership.pptx") }).then((f) => console.log("wrote", f));
