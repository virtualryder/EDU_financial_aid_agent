...
(() => {
  ...
  const stats = [["300/300", "automated tests green", MINT], ["10/10", "concurrent runs live-proven", TEAL], ["0", "PII hits in any telemetry (strict canary)", AMBER], ["0", "residual on teardown", NAVY]];
