...
proof is the 265-test offline suite (incl. full CDK assertions) PLUS the captured EP1 live run. Independent third-party reproduction (the OIDC release-validation workflow) is the remaining validation step.
...
EP0 + EP1 **complete**; current suite **265 tests**; `v0.1.3-pilot-rc1` released with captured EP1 evidence,
