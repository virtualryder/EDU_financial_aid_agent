...
> validated release tag [`v0.4.0-pilot-rc1`](https://github.com/virtualryder/EDU_financial_aid_agent/releases/tag/v0.4.0-pilot-rc1)**
...
```bash
git checkout v0.4.0-pilot-rc1            # deploy a VALIDATED RELEASE TAG, never main
...
can be, enforced in CI (suite **299 tests**). Start with the plan, then the specific docs:
