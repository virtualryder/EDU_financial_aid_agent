...
suite **318 tests**. **Owner:** David Ryder (AWS HCLS SA). **Last updated:** 2026-07-26.
...
the current authoritative count is **318 tests** (`RELEASE-MANIFEST.md`). Remaining Gate-B items are engagement actions
