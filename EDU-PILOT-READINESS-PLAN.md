...
suite **300 tests**. **Owner:** David Ryder (AWS HCLS SA). **Last updated:** 2026-07-26.
...
the current authoritative count is **300 tests** (`RELEASE-MANIFEST.md`). Remaining Gate-B items are engagement actions
