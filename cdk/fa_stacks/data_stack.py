...
class DataStack(cdk.Stack):
    def __init__(self, scope: Construct, cid: str, *, prefix: str,
        ...
        # Hybrid multi-tenant (phase 107/109): when a tenant is pinned to THIS data stack, every physical
        # store name is tenant-scoped so each tenant's regulated (FERPA) data lives in its OWN tables and
        # WORM bucket - physical isolation, not a shared table with a tenant key. Blank -> silo.
