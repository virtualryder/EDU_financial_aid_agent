...
def main():
    ...
    lam_groups = ["/aws/lambda/%s-%s" % (prefix, n) for n in ("ingest-case", "intake-fafsa", "lookup-coa", "mask-pii", "assess-aid",
                                                             "verify-documents", "professional-judgment", "core-tools", "write-audit", "request-signoff",
                                                             "signoff-register", "finalize", "workflow-guards", "tenant-interceptor", "approve-signoff")]
